...
const (
	...
	// MsgRegister - Initial message from revils with metadata
	...
	// MsgKillSessionReq - Kill request to the revils process
	MsgKillSessionReq
	...
	MsgExecuteAssembly
	// MsgInvokeMigrateReq - Spawn a new revils in a designated process
	MsgInvokeMigrateReq
