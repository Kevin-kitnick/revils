...
const (
	...
	// ConnectedEvent - Revils Connected
	SessionOpenedEvent = "session-connected"
	// DisconnectedEvent - Revils disconnected
	SessionClosedEvent = "session-disconnected"
	// UpdateEvent - Revils updated
...
const (
	...
	RevilsHelpGroup      = "Revils:"
	RevilsWinHelpGroup   = "Revils - Windows:"
	MultiplayerHelpGroup = "Multiplayer:"
	AliasHelpGroup       = "Revils - 3rd Party macros:"
	ExtensionHelpGroup   = "Revils - 3rd Party extensions:"
)
