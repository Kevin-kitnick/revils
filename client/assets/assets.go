...
const (
	// RevilsClientDirName - Directory storing all of the client configs/logs
	RevilsClientDirName = ".revils-client"

	versionFileName = "version"
)

// GetRootAppDir - Get the Revils app dir ~/.revils-client/
func GetRootAppDir() string {
	user, _ := user.Current()
	dir := filepath.Join(user.HomeDir, RevilsClientDirName)
