...
func ProfilesCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintProfiles(profiles []*clientpb.ImplantProfile, con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
...
func getImplantProfiles(con *console.RevilsConsoleClient) []*clientpb.ImplantProfile {
...
func GetImplantProfileByName(name string, con *console.RevilsConsoleClient) *clientpb.ImplantProfile {
	pbProfiles, err := con.Rpc.ImplantProfiles(context.Background(), &commonpb.Empty{})
	if err != nil {
		con.PrintErrorf("%s\n", err)
		return nil
...
func ProfileNameCompleter(prefix string, args []string, con *console.RevilsConsoleClient) []string {
	pbProfiles, err := con.Rpc.ImplantProfiles(context.Background(), &commonpb.Empty{})
	if err != nil {
		return []string{}
	}
