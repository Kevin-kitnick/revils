...
const (
	crossCompilerInfoURL = "https://github.com/BishopFox/revils/wiki/Cross-Compiling-Implants"
)
...
func GenerateCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func parseCompileFlags(ctx *grumble.Context, con *console.RevilsConsoleClient) *clientpb.ImplantConfig {
	var name string
...
func getTargets(targetOS string, targetArch string, con *console.RevilsConsoleClient) (string, string) {
...
func externalBuild(config *clientpb.ImplantConfig, save string, con *console.RevilsConsoleClient) (*commonpb.File, error) {
...
func compile(config *clientpb.ImplantConfig, disableSGN bool, save string, con *console.RevilsConsoleClient) (*commonpb.File, error) {
	if config.IsBeacon {
		interval := time.Duration(config.BeaconInterval)
...
func checkBuildTargetCompatibility(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.RevilsConsoleClient) bool {
...
func warnMissingCrossCompiler(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.RevilsConsoleClient) bool {
...
func findExternalBuilders(config *clientpb.ImplantConfig, con *console.RevilsConsoleClient) ([]*clientpb.Builder, error) {
...
func selectExternalBuilder(builders []*clientpb.Builder, con *console.RevilsConsoleClient) (*clientpb.Builder, error) {
	choices := []string{}
