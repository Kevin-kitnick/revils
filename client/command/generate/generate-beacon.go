...
func GenerateBeaconCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func parseBeaconFlags(ctx *grumble.Context, con *console.RevilsConsoleClient, config *clientpb.ImplantConfig) error {
