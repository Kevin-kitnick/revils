...
func ReactionCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	totalReactions := 0
...
func displayReactionsTable(eventType string, reactions []core.Reaction, con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
