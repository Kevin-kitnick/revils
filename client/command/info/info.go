...
func InfoCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
...
func PIDCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func UIDCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
...
func GIDCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
...
func WhoamiCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	if isWin {
		cto, err := con.Rpc.CurrentTokenOwner(context.Background(), &revilspb.CurrentTokenOwnerReq{
...
func PrintTokenOwner(cto *revilspb.CurrentTokenOwner, con *console.RevilsConsoleClient) {
