...
func RegDeleteKeyCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	deleteKey, err := con.Rpc.RegistryDeleteKey(context.Background(), &revilspb.RegistryDeleteKeyReq{
		Hive:     hive,
		Path:     finalPath,
		Key:      key,
		Hostname: hostname,
...
func PrintDeleteKey(deleteKey *revilspb.RegistryDeleteKey, regPath string, key string, con *console.RevilsConsoleClient) {
