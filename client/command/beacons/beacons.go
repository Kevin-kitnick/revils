...
func BeaconsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintBeacons(beacons []*clientpb.Beacon, filter string, filterRegex *regexp.Regexp, con *console.RevilsConsoleClient) {
	if len(beacons) == 0 {
...
func renderBeacons(beacons []*clientpb.Beacon, filter string, filterRegex *regexp.Regexp, con *console.RevilsConsoleClient) table.Writer {
