...
func SelectBeacon(con *console.RevilsConsoleClient) (*clientpb.Beacon, error) {
...
func GetBeacon(con *console.RevilsConsoleClient, beaconID string) (*clientpb.Beacon, error) {
	beacons, err := con.Rpc.GetBeacons(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, err
	}
...
func GetBeacons(con *console.RevilsConsoleClient) (*clientpb.Beacons, error) {
	beacons, err := con.Rpc.GetBeacons(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, err
	}
