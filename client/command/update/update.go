...
func UpdateCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func VerboseVersionsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func clientAssetForGOOS(assets []version.Asset) *version.Asset {
	...
	prefix := "revils-client"
	return findAssetFor(prefix, suffixes, assets)
}

func updateAvailable(con *console.RevilsConsoleClient, client *http.Client, release *version.Release, saveTo string) {
