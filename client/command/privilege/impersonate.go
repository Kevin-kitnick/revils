...
func ImpersonateCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	impersonate, err := con.Rpc.Impersonate(context.Background(), &revilspb.ImpersonateReq{
...
func PrintImpersonate(impersonate *revilspb.Impersonate, username string, con *console.RevilsConsoleClient) {
