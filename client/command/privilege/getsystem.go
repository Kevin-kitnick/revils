...
func GetSystemCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	ctrl := make(chan bool)
	con.SpinUntil("Attempting to create a new revils session as 'NT AUTHORITY\\SYSTEM'...", ctrl)
...
func PrintGetSystem(getsystemResp *revilspb.GetSystem, con *console.RevilsConsoleClient) {
