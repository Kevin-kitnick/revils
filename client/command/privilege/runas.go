...
func RunAsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	runAs, err := con.Rpc.RunAs(context.Background(), &revilspb.RunAsReq{
...
func PrintRunAs(runAs *revilspb.RunAs, process string, args string, name string, con *console.RevilsConsoleClient) {
