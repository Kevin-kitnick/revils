...
func GetPrivsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	privs, err := con.Rpc.GetPrivs(context.Background(), &revilspb.GetPrivsReq{
...
func PrintGetPrivs(privs *revilspb.GetPrivs, pid int32, con *console.RevilsConsoleClient) {
