...
func OperatorsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func displayOperators(operators []*clientpb.Operator, con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
