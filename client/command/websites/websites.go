...
func WebsitesCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func ListWebsites(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func ListWebsiteContent(websiteName string, con *console.RevilsConsoleClient) {
...
func PrintWebsite(web *clientpb.Website, con *console.RevilsConsoleClient) {
