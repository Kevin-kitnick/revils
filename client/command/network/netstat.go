...
func NetstatCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	netstat, err := con.Rpc.Netstat(context.Background(), &revilspb.NetstsatReq{
...
func PrintNetstat(netstat *revilspb.Netstat, implantPID int32, activeC2 string, numeric bool, con *console.RevilsConsoleClient) {
	lookup := func(skaddr *revilspb.SockTabEntry_SockAddr) string {
		addr := skaddr.Ip
