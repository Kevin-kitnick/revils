...
func IfconfigCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	ifconfig, err := con.Rpc.Ifconfig(context.Background(), &revilspb.IfconfigReq{
...
func PrintIfconfig(ifconfig *revilspb.Ifconfig, all bool, con *console.RevilsConsoleClient) {
	var err error
