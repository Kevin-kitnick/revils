...
func UseCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func SessionOrBeaconByID(id string, con *console.RevilsConsoleClient) (*clientpb.Session, *clientpb.Beacon, error) {
...
func SelectSessionOrBeacon(con *console.RevilsConsoleClient) (*clientpb.Session, *clientpb.Beacon, error) {
...
func BeaconAndSessionIDCompleter(prefix string, args []string, con *console.RevilsConsoleClient) (results []string) {
	sessions, err := con.Rpc.GetSessions(context.Background(), &commonpb.Empty{})
	if err != nil {
		return
	}
