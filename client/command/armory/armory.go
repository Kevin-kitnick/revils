...
func ArmoryCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func AliasExtensionOrBundleCompleter(prefix string, args []string, con *console.RevilsConsoleClient) []string {
	results := []string{}
...
func PrintArmoryPackages(aliases []*alias.AliasManifest, exts []*extensions.ExtensionManifest, con *console.RevilsConsoleClient) {
...
func PrintArmoryBundles(bundles []*ArmoryBundle, con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
	tw.SetStyle(settings.GetTableStyle(con))
