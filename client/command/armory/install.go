...
import (
	...
	"github.com/Kevin-kitnick/revils/server/cryptography/minisign"
...
func ArmoryInstallCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func installBundle(bundle *ArmoryBundle, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) {
...
func installPackageByName(name string, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) error {
	aliases, extensions := packagesInCache()
...
func installAlias(alias *alias.AliasManifest, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) {
...
func installAliasPackageByName(name string, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) error {
	...
	tmpFile, err := ioutil.TempFile("", "revils-armory-")
	if err != nil {
		return err
	}
...
func installExtension(ext *extensions.ExtensionManifest, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) {
...
func resolveExtensionPackageDependencies(name string, deps map[string]struct{}, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) {
	var entry *pkgCacheEntry
	pkgCache.Range(func(key, value interface{}) bool {
		cacheEntry := value.(pkgCacheEntry)
		if cacheEntry.Pkg.CommandName == name {
...
func installExtensionPackageByName(name string, clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) error {
	var entry *pkgCacheEntry
	pkgCache.Range(func(key, value interface{}) bool {
		cacheEntry := value.(pkgCacheEntry)
		if cacheEntry.Pkg.CommandName == name {
