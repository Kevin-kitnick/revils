...
func ArmoryUpdateCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func checkForAliasUpdates(clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) []string {
...
func checkForExtensionUpdates(clientConfig ArmoryHTTPConfig, con *console.RevilsConsoleClient) []string {
