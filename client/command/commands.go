...
import (
	...
	"github.com/Kevin-kitnick/revils/client/command/alias"
	"github.com/Kevin-kitnick/revils/client/command/armory"
	"github.com/Kevin-kitnick/revils/client/command/backdoor"
	"github.com/Kevin-kitnick/revils/client/command/beacons"
	"github.com/Kevin-kitnick/revils/client/command/builders"
	"github.com/Kevin-kitnick/revils/client/command/completers"
	"github.com/Kevin-kitnick/revils/client/command/cursed"
	"github.com/Kevin-kitnick/revils/client/command/dllhijack"
	...
	"github.com/Kevin-kitnick/revils/client/command/generate"
	"github.com/Kevin-kitnick/revils/client/command/help"
	"github.com/Kevin-kitnick/revils/client/command/hosts"
	"github.com/Kevin-kitnick/revils/client/command/info"
	"github.com/Kevin-kitnick/revils/client/command/jobs"
	"github.com/Kevin-kitnick/revils/client/command/kill"
	"github.com/Kevin-kitnick/revils/client/command/loot"
	"github.com/Kevin-kitnick/revils/client/command/monitor"
	"github.com/Kevin-kitnick/revils/client/command/network"
	"github.com/Kevin-kitnick/revils/client/command/operators"
	"github.com/Kevin-kitnick/revils/client/command/pivots"
	"github.com/Kevin-kitnick/revils/client/command/portfwd"
	operator "github.com/Kevin-kitnick/revils/client/command/prelude-operator"
	"github.com/Kevin-kitnick/revils/client/command/privilege"
	"github.com/Kevin-kitnick/revils/client/command/processes"
	"github.com/Kevin-kitnick/revils/client/command/reaction"
	"github.com/Kevin-kitnick/revils/client/command/reconfig"
	"github.com/Kevin-kitnick/revils/client/command/registry"
	"github.com/Kevin-kitnick/revils/client/command/rportfwd"
	"github.com/Kevin-kitnick/revils/client/command/screenshot"
	"github.com/Kevin-kitnick/revils/client/command/sessions"
	"github.com/Kevin-kitnick/revils/client/command/settings"
	"github.com/Kevin-kitnick/revils/client/command/shell"
	sgn "github.com/Kevin-kitnick/revils/client/command/shikata-ga-nai"
	"github.com/Kevin-kitnick/revils/client/command/socks"
	"github.com/Kevin-kitnick/revils/client/command/tasks"
	"github.com/Kevin-kitnick/revils/client/command/update"
	"github.com/Kevin-kitnick/revils/client/command/use"
	"github.com/Kevin-kitnick/revils/client/command/websites"
	"github.com/Kevin-kitnick/revils/client/command/wireguard"
	"github.com/Kevin-kitnick/revils/client/console"
	consts "github.com/Kevin-kitnick/revils/client/constants"
	"github.com/Kevin-kitnick/revils/client/licenses"
...
func BindCommands(con *console.RevilsConsoleClient) {
	...
	con.App.AddCommand(&grumble.Command{
		...
		HelpGroup: consts.RevilsHelpGroup,
	})
	...
	con.App.AddCommand(&grumble.Command{
		...
		Flags: func(f *grumble.Flags) {
			...
			f.Bool("i", "in-process", false, "Run in the current revils process")
		...
		HelpGroup: consts.RevilsWinHelpGroup,
	})

	con.App.AddCommand(&grumble.Command{
		Name:     consts.ExecuteShellcodeStr,
		Help:     "Executes the given shellcode in the revils process",
	...
	con.App.AddCommand(&grumble.Command{
		...
		Help:     "Start a revils service on a remote target",
		LongHelp: help.GetHelpFor([]string{consts.PsExecStr}),
		Flags: func(f *grumble.Flags) {
			f.Int("t", "timeout", defaultTimeout, "command timeout in seconds")
			f.String("s", "service-name", "Revils", "name that will be used to register the service")
			f.String("d", "service-description", "Revils implant", "description of the service")
			...
			f.String("c", "custom-exe", "", "custom service executable to use instead of generating a new Revils")
		},
		Run: func(ctx *grumble.Context) error {
			con.Println()
	...
	generateCmd := &grumble.Command{
		...
		Flags: func(f *grumble.Flags) {
			...
			f.String("I", "template", "revils", "implant code template")
	...
	con.App.AddCommand(&grumble.Command{
		...
		Help:     "Spawns a new revils session as the NT AUTHORITY\\SYSTEM user (Windows Only)",
	...
	con.App.AddCommand(&grumble.Command{
		...
		Help:     "Infect a remote file with a revils shellcode",
	...
	monitorCmd := &grumble.Command{
		...
		Help: "Monitor threat intel platforms for Revils implants",
	}
	...
	operatorCmd.AddCommand(&grumble.Command{
		...
		Flags: func(f *grumble.Flags) {
			...
			f.String("r", "range", "revils", "Agents range")
		},
	})
