...
func CursedConsoleCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func selectDebugTarget(targets []overlord.ChromeDebugTarget, con *console.RevilsConsoleClient) *overlord.ChromeDebugTarget {
	if len(targets) < 1 {
...
func startCursedConsole(curse *core.CursedProcess, helpers bool, target *overlord.ChromeDebugTarget, con *console.RevilsConsoleClient) {
