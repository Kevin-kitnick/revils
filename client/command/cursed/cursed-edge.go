...
func CursedEdgeCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func avadaKedavraEdge(session *clientpb.Session, ctx *grumble.Context, con *console.RevilsConsoleClient) *core.CursedProcess {
	...
	if edgeProcess != nil {
		...
		con.PrintWarnf("Revils will need to kill and restart the Edge process in order to perform code injection.\n")
...
func getEdgeProcess(session *clientpb.Session, ctx *grumble.Context, con *console.RevilsConsoleClient) (*commonpb.Process, error) {
