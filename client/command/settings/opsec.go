...
func SettingsAutoAdultCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
...
func IsUserAnAdult(con *console.RevilsConsoleClient) bool {
	if GetAutoAdult(con) {
		return true
	}
	confirm := false
...
func GetAutoAdult(con *console.RevilsConsoleClient) bool {
	if con.Settings == nil {
