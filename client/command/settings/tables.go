...
var (
	tableStyles = map[string]table.Style{
		// Revils styles
		RevilsDefault.Name: RevilsDefault,
	...
	revilsBordersDefault = table.Style{
		Name: "RevilsBordersDefault",
		Box: table.BoxStyle{
			BottomLeft:       "+",
			BottomRight:      "+",
			BottomSeparator:  "-",
...
func GetTableStyle(con *console.RevilsConsoleClient) table.Style {
	if con.Settings == nil {
	...
	return tableStyles[RevilsDefault.Name]
}

// GetTableWithBordersStyle - Get the table style with borders
func GetTableWithBordersStyle(con *console.RevilsConsoleClient) table.Style {
	if con.Settings == nil {
		con.Settings, _ = assets.LoadSettings()
	}
	value, ok := tableStyles[con.Settings.TableStyle]
	if !ok || con.Settings.TableStyle == RevilsDefault.Name {
		return revilsBordersDefault
	}
	return value
}
...
func PaginateTable(tw table.Writer, skipPages int, overflow bool, interactive bool, con *console.RevilsConsoleClient) {
