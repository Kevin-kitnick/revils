...
func SettingsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
...
func SettingsAlwaysOverflow(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsSmallTerm(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsTablesCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsSaveCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
