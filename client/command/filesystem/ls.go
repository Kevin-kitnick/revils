...
func LsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
// PrintLs - Display an revilspb.Ls object
func PrintLs(ls *revilspb.Ls, flags grumble.FlagMap, con *console.RevilsConsoleClient) {
