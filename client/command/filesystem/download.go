...
func DownloadCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func HandleDownloadResponse(download *revilspb.Download, ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var err error
