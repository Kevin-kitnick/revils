...
func MemfilesRmCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	memfilesList, err := con.Rpc.MemfilesRm(context.Background(), &revilspb.MemfilesRmReq{
...
func PrintRmMemfile(memfilesList *revilspb.MemfilesRm, con *console.RevilsConsoleClient) {
