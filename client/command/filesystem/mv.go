...
func MvCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) (err error) {
	...
	mv, err := con.Rpc.Mv(context.Background(), &revilspb.MvReq{
...
func PrintMv(mv *revilspb.Mv, con *console.RevilsConsoleClient) {
