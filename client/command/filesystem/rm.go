...
func RmCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	rm, err := con.Rpc.Rm(context.Background(), &revilspb.RmReq{
...
func PrintRm(rm *revilspb.Rm, con *console.RevilsConsoleClient) {
