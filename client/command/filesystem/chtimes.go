...
func ChtimesCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	chtimes, err := con.Rpc.Chtimes(context.Background(), &revilspb.ChtimesReq{
...
func PrintChtimes(chtimes *revilspb.Chtimes, con *console.RevilsConsoleClient) {
