...
func ChownCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	chown, err := con.Rpc.Chown(context.Background(), &revilspb.ChownReq{
...
func PrintChown(chown *revilspb.Chown, con *console.RevilsConsoleClient) {
