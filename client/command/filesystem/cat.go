...
func CatCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintCat(download *revilspb.Download, ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var (
...
func colorize(f *revilspb.Download) error {
