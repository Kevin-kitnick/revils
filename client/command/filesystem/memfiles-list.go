...
func MemfilesListCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}

	memfilesList, err := con.Rpc.MemfilesList(context.Background(), &revilspb.MemfilesListReq{
...
// PrintMemfiles - Display an revilspb.Ls object
func PrintMemfiles(ls *revilspb.Ls, con *console.RevilsConsoleClient) {
