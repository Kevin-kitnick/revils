...
func TasksCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintBeaconTasks(tasks []*clientpb.BeaconTask, ctx *grumble.Context, con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
