...
func SpawnDllCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	spawndll, err := con.Rpc.SpawnDll(context.Background(), &revilspb.InvokeSpawnDlllReq{
		Data:        binData,
...
func HandleSpawnDLLResponse(spawndll *revilspb.SpawnDll, binPath string, hostName string, ctx *grumble.Context, con *console.RevilsConsoleClient) {
