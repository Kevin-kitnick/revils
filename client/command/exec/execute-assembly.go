...
func ExecuteAssemblyCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	execAssembly, err := con.Rpc.ExecuteAssembly(context.Background(), &revilspb.ExecuteAssemblyReq{
...
func HandleExecuteAssemblyResponse(execAssembly *revilspb.ExecuteAssembly, assemblyPath string, hostName string, ctx *grumble.Context, con *console.RevilsConsoleClient) {
