...
func JobsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintJobs(jobs map[uint32]*clientpb.Job, con *console.RevilsConsoleClient) {
...
func jobKill(jobID uint32, con *console.RevilsConsoleClient) {
...
func killAllJobs(con *console.RevilsConsoleClient) {
	jobs, err := con.Rpc.GetJobs(context.Background(), &commonpb.Empty{})
	if err != nil {
		con.PrintErrorf("%s\n", err)
		return
