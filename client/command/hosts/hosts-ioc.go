...
func HostsIOCCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func hostIOCsTable(host *clientpb.Host, con *console.RevilsConsoleClient) string {
	tw := table.NewWriter()
...
func SelectHostIOC(host *clientpb.Host, con *console.RevilsConsoleClient) (*clientpb.IOC, error) {
