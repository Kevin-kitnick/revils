...
func HostsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func hostsTable(hosts []*clientpb.Host, con *console.RevilsConsoleClient) string {
	tw := table.NewWriter()
...
func hostSessions(hostUUID string, con *console.RevilsConsoleClient) string {
...
func hostBeacons(hostUUID string, con *console.RevilsConsoleClient) string {
...
func SessionsForHost(hostUUID string, con *console.RevilsConsoleClient) []*clientpb.Session {
...
func SelectHost(con *console.RevilsConsoleClient) (*clientpb.Host, error) {
	allHosts, err := con.Rpc.Hosts(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, err
	}
