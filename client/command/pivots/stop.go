...
func StopPivotListenerCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	_, err := con.Rpc.PivotStopListener(context.Background(), &revilspb.PivotStopListenerReq{
		ID:      id,
		Request: con.ActiveTarget.Request(ctx),
	})
	if err != nil {
