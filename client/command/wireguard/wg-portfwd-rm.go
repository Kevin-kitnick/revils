...
func WGPortFwdRmCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	stopReq, err := con.Rpc.WGStopPortForward(context.Background(), &revilspb.WGPortForwardStopReq{
		ID:      int32(fwdID),
