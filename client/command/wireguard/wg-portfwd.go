...
func WGPortFwdListCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	fwdList, err := con.Rpc.WGListForwarders(context.Background(), &revilspb.WGTCPForwardersReq{
