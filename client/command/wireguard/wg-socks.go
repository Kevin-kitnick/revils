...
func WGSocksListCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	...
	socksList, err := con.Rpc.WGListSocksServers(context.Background(), &revilspb.WGSocksServersReq{
