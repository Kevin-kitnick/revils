...
func AddLootFile(rpc rpcpb.RevilsRPCClient, name string, fileName string, data []byte, isCredential bool) error {
	if len(data) < 1 {
...
func AddLootUserPassword(rpc rpcpb.RevilsRPCClient, name string, user string, password string) error {
	loot := &clientpb.Loot{
		Name:           name,
...
func AddLootAPIKey(rpc rpcpb.RevilsRPCClient, name string, apiKey string) error {
	loot := &clientpb.Loot{
		Name:           name,
		Type:           clientpb.LootType_LOOT_CREDENTIAL,
...
func SelectCredentials(con *console.RevilsConsoleClient) (*clientpb.Loot, error) {
...
func SelectLoot(ctx *grumble.Context, rpc rpcpb.RevilsRPCClient) (*clientpb.Loot, error) {
