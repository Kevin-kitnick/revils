...
func AliasesInstallCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func installFromDir(aliasLocalPath string, con *console.RevilsConsoleClient) {
...
func InstallFromFile(aliasGzFilePath string, autoOverwrite bool, con *console.RevilsConsoleClient) *string {
...
func installArtifact(aliasGzFilePath string, installPath, artifactPath string, con *console.RevilsConsoleClient) error {
