...
// AliasesRemoveCmd - Locally load a alias into the Revils shell.
func AliasesRemoveCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func RemoveAliasByCommandName(commandName string, con *console.RevilsConsoleClient) error {
	if commandName == "" {
