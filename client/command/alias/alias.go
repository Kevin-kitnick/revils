...
func AliasesCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintAliases(con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
...
func AliasCommandNameCompleter(prefix string, args []string, con *console.RevilsConsoleClient) []string {
	results := []string{}
