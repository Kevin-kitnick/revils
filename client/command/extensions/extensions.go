...
func ExtensionsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintExtensions(con *console.RevilsConsoleClient) {
	tw := table.NewWriter()
...
func ExtensionsCommandNameCompleter(prefix string, args []string, con *console.RevilsConsoleClient) []string {
	installedManifests := getInstalledManifests()
	results := []string{}
