...
func ExtensionLoadCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func ExtensionRegisterCommand(extCmd *ExtensionManifest, con *console.RevilsConsoleClient) {
...
func loadExtension(goos string, goarch string, checkCache bool, ext *ExtensionManifest, ctx *grumble.Context, con *console.RevilsConsoleClient) error {
	...
	if checkCache {
		extList, err := con.Rpc.ListExtensions(context.Background(), &revilspb.ListExtensionsReq{
...
func registerExtension(goos string, ext *ExtensionManifest, binData []byte, ctx *grumble.Context, con *console.RevilsConsoleClient) error {
	registerResp, err := con.Rpc.RegisterExtension(context.Background(), &revilspb.RegisterExtensionReq{
...
func loadDep(goos string, goarch string, depName string, ctx *grumble.Context, con *console.RevilsConsoleClient) error {
...
func runExtensionCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
	var (
		err           error
		extensionArgs []byte
		extName       string
	...
	callExtResp, err := con.Rpc.CallExtension(context.Background(), &revilspb.CallExtensionReq{
		Name:    extName,
		Export:  entryPoint,
		Args:    extensionArgs,
		Request: con.ActiveTarget.Request(ctx),
...
func PrintExtOutput(extName string, commandName string, callExtension *revilspb.CallExtension, con *console.RevilsConsoleClient) {
