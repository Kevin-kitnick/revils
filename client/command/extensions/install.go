...
func ExtensionsInstallCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func installFromDir(extLocalPath string, con *console.RevilsConsoleClient) {
...
func InstallFromFilePath(extLocalPath string, autoOverwrite bool, con *console.RevilsConsoleClient) *string {
...
func installArtifact(extGzFilePath string, installPath string, artifactPath string, con *console.RevilsConsoleClient) error {
