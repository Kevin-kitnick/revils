...
func ExtensionsRemoveCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func RemoveExtensionByCommandName(commandName string, con *console.RevilsConsoleClient) error {
	if commandName == "" {
