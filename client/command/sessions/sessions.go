...
func SessionsCmd(ctx *grumble.Context, con *console.RevilsConsoleClient) {
...
func PrintSessions(sessions map[string]*clientpb.Session, filter string, filterRegex *regexp.Regexp, con *console.RevilsConsoleClient) {
