...
// MTLSConnect - Connect to the revils server
func MTLSConnect(config *assets.ClientConfig) (rpcpb.RevilsRPCClient, *grpc.ClientConn, error) {
	...
	return rpcpb.NewRevilsRPCClient(connection), connection, nil
}
