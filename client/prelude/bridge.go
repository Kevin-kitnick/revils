...
// OperatorImplantBridge maps the Revils implants (whether it be a beacon or a session)
...
func NewImplantBridge(c *net.Conn, a ActiveImplant, rpc rpcpb.RevilsRPCClient, pbeacon OperatorBeacon, conf AgentConfig, callback func(string, func(*clientpb.BeaconTask))) *OperatorImplantBridge {
...
func (a *OperatorImplantBridge) refreshBeacon() {
	var pwd string
	pwdResp, _ := a.RPC.Pwd(context.Background(), &revilspb.PwdReq{
