...
import (
	...
	"github.com/Kevin-kitnick/revils/client/prelude/util"
...
// active Revils implant sessions/beacons
...
// Revils clientpb.Session and clientpb.Beacon
...
func (p *OperatorImplantMapper) AddImplant(a ActiveImplant, callback func(string, func(*clientpb.BeaconTask))) error {
	...
	pwdResp, err := p.conf.RPC.Pwd(context.Background(), &revilspb.PwdReq{
