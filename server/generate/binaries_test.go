...
func TestRevilsExecutableWindows(t *testing.T) {
...
func TestRevilsSharedLibWindows(t *testing.T) {
...
func TestRevilsExecutableLinux(t *testing.T) {
...
func TestRevilsSharedLibraryLinux(t *testing.T) {
...
func TestRevilsExecutableDarwin(t *testing.T) {
...
func TestRevilsDefaultBuild(t *testing.T) {
...
func mtlsExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("mtls_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func dnsExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("dns_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func httpExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("http_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func multiExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("multi_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func multiWindowsService(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("service_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func tcpPivotExe(t *testing.T, goos string, goarch string, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("tcpPivot_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func namedPipeExe(t *testing.T, goos string, goarch string, debug bool) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("namedpipe_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func wireguardExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	certs.SetupWGKeys()
	_, err := RevilsExecutable(fmt.Sprintf("wireguard_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func multiLibrary(t *testing.T, goos string, goarch string, debug bool) {
	...
	nonce++
	_, err := RevilsSharedLibrary(fmt.Sprintf("multilibrary_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func symbolObfuscation(t *testing.T, goos string, goarch string) {
	...
	nonce++
	_, err := RevilsExecutable(fmt.Sprintf("symbol_test%d", nonce), otpTestSecret, config, true)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
