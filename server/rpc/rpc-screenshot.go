...
func (rpc *Server) Screenshot(ctx context.Context, req *revilspb.ScreenshotReq) (*revilspb.Screenshot, error) {
	resp := &revilspb.Screenshot{Response: &commonpb.Response{}}
