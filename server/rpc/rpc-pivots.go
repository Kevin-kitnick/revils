...
func (rpc *Server) PivotSessionListeners(ctx context.Context, req *revilspb.PivotListenersReq) (*revilspb.PivotListeners, error) {
	resp := &revilspb.PivotListeners{Response: &commonpb.Response{}}
...
func (rpc *Server) PivotStartListener(ctx context.Context, req *revilspb.PivotStartListenerReq) (*revilspb.PivotListener, error) {
	resp := &revilspb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
	}
...
func (rpc *Server) PivotStopListener(ctx context.Context, req *revilspb.PivotStopListenerReq) (*commonpb.Empty, error) {
	resp := &revilspb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
