...
func (rpc *Server) Reconfigure(ctx context.Context, req *revilspb.ReconfigureReq) (*revilspb.Reconfigure, error) {
	...
	resp := &revilspb.Reconfigure{Response: &commonpb.Response{}}
