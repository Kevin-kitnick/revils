...
func (rpc *Server) Generate(ctx context.Context, req *clientpb.GenerateReq) (*clientpb.Generate, error) {
	...
	if config.TemplateName == "" {
		config.TemplateName = generate.RevilsTemplateName
	}
	...
	case clientpb.OutputFormat_EXECUTABLE:
		fPath, err = generate.RevilsExecutable(name, otpSecret, config, true)
	case clientpb.OutputFormat_SHARED_LIB:
		fPath, err = generate.RevilsSharedLibrary(name, otpSecret, config, true)
...
func (rpc *Server) GenerateExternal(ctx context.Context, req *clientpb.ExternalGenerateReq) (*clientpb.ExternalImplantConfig, error) {
	...
	externalConfig, err := generate.RevilsExternal(name, config)
	if err != nil {
		return nil, err
	}
...
// BuilderRegister
func (rpc *Server) BuilderRegister(req *clientpb.Builder, stream rpcpb.RevilsRPC_BuilderRegisterServer) error {
