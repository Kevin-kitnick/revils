...
import (
	...
	clientconsole "github.com/Kevin-kitnick/revils/client/console"
	consts "github.com/Kevin-kitnick/revils/client/constants"
	clienttransport "github.com/Kevin-kitnick/revils/client/transport"
	"github.com/Kevin-kitnick/revils/protobuf/rpcpb"
	"github.com/Kevin-kitnick/revils/server/configs"
	"github.com/Kevin-kitnick/revils/server/transport"
...
func Start() {
	...
	defer conn.Close()
	localRPC := rpcpb.NewRevilsRPCClient(conn)
...
func serverOnlyCmds(console *clientconsole.RevilsConsoleClient) {
