...
import (
	...
	"github.com/Kevin-kitnick/revils/protobuf/dnspb"
	...
	revilsHandlers "github.com/Kevin-kitnick/revils/server/handlers"
...
func StartDNSListener(bindIface string, lport uint16, domains []string, canaries bool, enforceOTP bool) *RevilsDNSServer {
	// StartPivotListener()
	server := &RevilsDNSServer{
...
func (s *DNSSession) StageOutgoingEnvelope(envelope *revilspb.Envelope) error {
...
func (s *DNSSession) ForwardCompletedEnvelope(msgID uint32, pending *PendingEnvelope) {
	...
	handlers := revilsHandlers.GetHandlers()
	if envelope.ID != 0 {
...
// RevilsDNSServer - DNS server implementation
type RevilsDNSServer struct {
	server       *dns.Server
	sessions     *sync.Map
	messages     *sync.Map
	TTL          uint32
...
func (s *RevilsDNSServer) Shutdown() error {
	return s.server.Shutdown()
}

// ListenAndServe - Listen for DNS requests and respond
func (s *RevilsDNSServer) ListenAndServe() error {
...
func (s *RevilsDNSServer) HandleDNSRequest(domains []string, canaries bool, writer dns.ResponseWriter, req *dns.Msg) {
	if req == nil {
...
func (s *RevilsDNSServer) isC2SubDomain(domains []string, reqDomain string) (bool, string) {
...
func (s *RevilsDNSServer) handleC2(domain string, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) decodeSubdata(subdomain string) (*dnspb.DNSMessage, uint32, error) {
...
func (s *RevilsDNSServer) determineLikelyEncoders(subdata string) []encoders.Encoder {
...
func (s *RevilsDNSServer) nameErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
func (s *RevilsDNSServer) refusedErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
// ---------------------------
func (s *RevilsDNSServer) handleTOTP(domain string, msg *dnspb.DNSMessage, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleDNSSessionInit(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handlePoll(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleDataFromImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleDataToImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleClear(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleNOP(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *RevilsDNSServer) handleCanary(req *dns.Msg) *dns.Msg {
