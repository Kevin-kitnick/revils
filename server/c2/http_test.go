...
import (
	...
	implantCrypto "github.com/Kevin-kitnick/revils/implant/revils/cryptography"
	implantEncoders "github.com/Kevin-kitnick/revils/implant/revils/encoders"
	implantTransports "github.com/Kevin-kitnick/revils/implant/revils/transports/httpclient"
...
func TestStartSessionHandler(t *testing.T) {
	...
	client := implantTransports.RevilsHTTPClient{}
	baseURL := &url.URL{
		Scheme: "http",
		Host:   "127.0.0.1:8888",
	...
	httpSessionInit := &revilspb.HTTPSescionInit{Key: sKey[:]}
