...
import (
	...
	clientAssets "github.com/Kevin-kitnick/revils/client/assets"
	...
	"github.com/Kevin-kitnick/revils/server/builder"
...
var builderCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		builderLog.Infof("Initializing Revils external builder - %s", version.FullVersion())
		...
		externalBuilder.Templates = []string{"revils"}
