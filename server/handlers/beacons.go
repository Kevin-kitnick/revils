...
func beaconRegisterHandler(implantConn *core.ImplantConnection, data []byte) *revilspb.Envelope {
	beaconReg := &revilspb.BeaconRegister{}
...
func auditLogBeacon(beacon *models.Beacon, register *revilspb.Register) {
...
func beaconTasksHandler(implantConn *core.ImplantConnection, data []byte) *revilspb.Envelope {
	beaconTasks := &revilspb.BeaconTasks{}
	...
	taskData, err := proto.Marshal(&revilspb.BeaconTasks{Tasks: tasks})
	if err != nil {
	...
	return &revilspb.Envelope{
		Type: revilspb.MsgBeaconTasks,
		Data: taskData,
	}
}

func beaconTaskResults(beaconID string, taskEnvelopes []*revilspb.Envelope) *revilspb.Envelope {
