...
func TestSplitBufferBase58(t *testing.T) {
	...
	for _, client := range []*RevilsDNSClient{client1, client2, client3} {
...
func clientSplitBuffer(t *testing.T, client *RevilsDNSClient, encoder encoders.Encoder, testData []byte) {
...
// func addTestResolver(client *RevilsDNSClient, enableBase58 bool) {
