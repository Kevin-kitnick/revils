...
func SocksReqHandler(envelope *revilspb.Envelope, connection *transports.Connection) {
...
func (s *socks) Write(b []byte) (n int, err error) {
	data, err := proto.Marshal(&revilspb.SocksData{
